...
**包含关键词**（必须包含其一）：
- 支付渠道：Visa, Mastercard, 万事达, PayPal
- 支付倡议：EPI, Wero, 数字欧元, 数字货币, CBDC
- 支付公司：Airwallex, PingPong, Worldpay
- 支付概念：支付主权, 支付倡议, 欧洲支付, 数字钱包, 跨境支付, 即时支付
- 金融机构：银行, 卡组织
...
- 2026-04-24：重构支付生态分类逻辑，从关键词匹配改为核心关键词+排除关键词模式，聚焦支付行业本身（支付渠道、支付公司、银行、卡组织、钱包、数字货币），排除应用商店生态相关新闻；优化应用生态和支付生态页面搜索功能，与首页保持一致；修复多条新闻分类错误
