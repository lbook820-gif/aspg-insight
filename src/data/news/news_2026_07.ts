...
export const news_2026_07: NewsItem[] = [
  ...
  {
    id: '194',
    title: 'EDPB发布生成式AI匿名化与网络爬取指南并最终确定区块链指南:为AI数据保护提供监管确定性',
    source: 'EDPB / 欧盟数据保护委员会',
    sourceUrl: 'https://www.edpb.europa.eu/news/news/2026/edpb-sheds-light-anonymisation-and-web-scraping-generative-ai-and-adopts-final_en',
    summary: '2026年7月8日,欧洲数据保护委员会(EDPB)发布两项重要指南:一是关于生成式AI场景下的匿名化与网络爬取的指南,为AI模型训练中的个人数据匿名化标准和从网络爬取数据的法律边界提供了明确解释;二是正式通过区块链指南终版。EDPB表示,生成式AI的蓬勃发展对数据保护提出了新挑战,特别是在网络爬取训练数据过程中涉及的个人数据保护问题。指南明确了何为"有效的匿名化",以及网络爬取行为在GDPR框架下的合法基础。区块链指南终版则厘清了分布式账本技术中数据处理者与控制者的责任划分。',
    aiComment: {
      overallImpact: 'EDPB此两项指南是对AI与数据保护交叉领域最迫切的监管空白的关键性填补。AI匿名化指南直接回应了ChatGPT等生成式AI爆发以来的核心争议:AI模型训练中使用网络爬取的公开数据是否受GDPR约束。指南明确了真正的匿名化(而非假名化)才可免除GDPR义务,意味着大部分使用公开数据训练的大模型仍需合规。区块链指南终版则为DeFi、数字资产托管等场景的数据处理者提供了合规边界。两项指南叠加将于8月2日生效的AI Act核心条款,欧盟AI数据保护监管框架从"法律文本"走向"实操指南"阶段。',
      huaweiImpact: 'EDPB的指南为华为在欧盟部署AI服务提供了合规确定性。华为若在欧盟提供基于大模型的服务(如华为云盘古大模型或终端侧AI),须确保训练数据的匿名化标准符合EDPB要求——简单的去标识化可能不够,需采用差分隐私等技术达到不可重识别标准。在区块链方面,华为云BCS服务在欧盟推广时,需根据指南明确分布式账本中的控制者/处理者角色划分。建议华为AI合规团队评估现有训练数据处理流程是否满足EDPB的匿名化标准,尤其是网络爬取数据的合法基础。',
    },
    publishDate: '2026-07-08',
    score: 8,
    category: 'dma',
    tags: ['EDPB', '生成式AI', '匿名化', '网络爬取', '区块链', '指南', '数据保护', 'GDPR', 'AI', '大模型', '合规'],
  },
  {
    id: '195',
    title: '欧盟发布AI网络安全行动计划:建立专属AI评测中心,2027年投入运营应对先进模型风险',
    source: '欧盟委员会 / 同花顺财经 / EEPW',
    sourceUrl: 'https://m.10jqka.com.cn/20260710/c678089392.shtml',
    summary: '2026年7月7日,欧盟委员会发布AI网络安全行动计划,旨在应对先进AI模型既是强⼒防御工具也可沦为攻击武器的双重属性。核心举措包括:1)招标建设欧盟专属AI网络安全评测中心,预计2027年投入运营,独立完成AI模型安全风险评估;2)联合ENISA制定欧洲统一规范,明确公共机构和企业合规获取高端AI模型的标准化流程;3)ENISA与联合研究中心共建安全测试平台,在仿真环境中完成AI系统安全测评,覆盖能源、金融、医疗、交通等关键行业。行动计划建立在AI Act、CRA、NIS2、DORA等现有法规体系之上,AI Act高端模型监管要求将于2026年8月2日实施。',
    aiComment: {
      overallImpact: '该行动计划是欧盟"事前监管"原则从数字平台向AI与网络安全的首次系统性扩展。"AI评测中心"的设计理念类似DMA的守门人认定机制——不是事后追责,而是事前评估。2027年投运的时间点与AI Act高风险条款实施周期一致,形成监管闭环。对全球AI治理而言,欧盟正在建立一套"AI系统上市前安全评估"的标准模式,与FDA药品审批或民航适航认证在逻辑上相似——这可能成为全球AI监管的"欧盟范式"。CRA(网络弹性法案)和NIS2(网络安全指令)的联动确保了AI安全不仅是模型层级的,还延伸到了IoT设备、供应链和关键基础设施。',
      huaweiImpact: '该计划对华为在欧盟的AI业务影响深远。华为云和终端AI产品若在欧盟投放,可能需要在2027年前通过欧盟AI评测中心的安全评估。建议华为:1)提前建立欧盟AI安全合规团队,跟踪评测中心技术标准制定进程;2)在盘古大模型等产品中预置符合欧盟标准的可审计安全模块;3)参与ENISA的标准制定咨询过程,争取在AI安全评价指标中贡献技术方案,避免评测标准被欧美企业完全主导。对华为云而言,"AI评测中心+安全测试平台"也为华为云在欧盟提供了差异化服务机会,如推出"符合EU AI安全标准"的AI基础设施方案。',
    },
    publishDate: '2026-07-07',
    score: 8,
    category: 'dma',
    tags: ['欧盟', 'AI', '网络安全', '行动计划', 'AI评测中心', 'ENISA', 'AI Act', 'CRA', 'NIS2', '先进模型', '监管'],
  },
  {
    id: '196',
    title: '欧盟委员会因NIS2指令未转化将爱尔兰、西班牙、法国和荷兰四国诉至欧洲法院',
    source: '欧盟委员会 / 财联社 / 东方财富网',
    sourceUrl: 'https://finance.eastmoney.com/a/202607083798538160.html',
    summary: '2026年7月8日,欧盟委员会正式将爱尔兰、西班牙、法国和荷兰四国诉至欧盟法院(CJEU),因其未能将NIS2网络安全指令(Directive (EU) 2022/2555)在规定期限内转化为国内法。NIS2指令于2023年1月生效,成员国应在2024年10月前完成转化,但上述四国至今未履行该义务。NIS2指令要求成员国对关键基础设施(能源、交通、医疗、数字基础设施等)实施强化网络安全要求,包括24小时内报告重大安全事件。欧盟委员会此前已多次发出正式通知,最终决定诉诸司法程序。',
    aiComment: {
      overallImpact: '欧盟委员会首次因NIS2转化不力大规模起诉成员国具有标志性意义。NIS2是欧盟网络安全立法的核心支柱,覆盖18个关键行业,其转化延迟直接削弱了欧洲数字主权建设的法律基础。四国被诉说明欧盟在网络安全领域的法律执行力正在升级:不再依赖"道德劝告",而是采用司法强制手段推动规则统一。考虑到2026年8月AI Act核心条款即将生效、CRA将于2027年底全面执行,欧盟正在构建的"多法协同"网络安全治理体系需要所有成员国的国内法基础同步到位——这意味着后续可能还有更多国家面临类似诉讼。',
      huaweiImpact: 'NIS2转化推进有利于华为在欧盟的网络安全合规策略获得更确定的法律环境。NIS2要求关键基础设施运营者实施供应链安全评估,华为作为ICT设备供应商将受益于统一的欧盟网络安全标准带来的规则透明化。但同时也意味着华为需确保其产品和解决方案在爱尔兰、西班牙、法国、荷兰四国满足NIS2的安全要求,包括事件报告、供应链风险评估和加密要求。建议华为将NIS2合规纳入欧洲业务的核心风险管理框架,重点关注与数字基础设施(5G、云计算)相关的供应商审查条款。',
    },
    publishDate: '2026-07-08',
    score: 7,
    category: 'dma',
    tags: ['NIS2', '网络安全', '欧盟委员会', '欧洲法院', '爱尔兰', '西班牙', '法国', '荷兰', '指令转化', '关键基础设施', 'CJEU'],
  }
];
