...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    source: '搜狐网 / 市场资讯',
    sourceUrl: 'https://news.sohu.com/a/966988620_114984',
    summary: '苹果公司宣布从2026年起在App Store搜索结果页面扩充广告位。目前App Store仅在搜索结果顶部设有一个广告位，未来新增的广告位将出现在搜索结果列表中更靠后的位置。苹果称近65%的下载发生在搜索之后，因此将在各类搜索查询中引入更多广告。广告主与开发者无法选择或竞价特定广告位置，实际展示位置将取决于竞价出价金额及其在拍卖中的排名。该功能将支持iOS 26.2与iPadOS 26.2及更高版本。',
    aiComment: {
      overallImpact: 'App Store广告位的扩充标志着苹果服务业务收入多元化的持续推进。更多广告位意味着开发者获客成本可能上升，同时自然搜索结果的可见性将下降。这对依赖ASO（应用商店优化）的开发者提出了更高要求，需要平衡自然流量与付费推广的投入比例。',
      huaweiImpact: '华为AppGallery的广告系统相对简单，苹果的广告扩展为其提供了参考方向。华为可考虑优化自身广告平台，吸引更多开发者投放广告，增加收入来源。同时，华为也可以主打"更少广告干扰"的用户体验差异化策略。',
    },
    publishDate: '2026-04-21',
    score: 7,
    category: 'appstore',
  ...
  },
  {
    ...
    aiComment: {
      ...
      huaweiImpact: '华为AppGallery同样需要建立完善的安全审核体系。Google的经验表明，AI和实时防御是应对恶意应用的关键技术。华为可以借鉴Google的多层防护机制，提升AppGallery的安全水平，增强用户和开发者的信任。',
    },
    publishDate: '2026-04-21',
    score: 7,
    category: 'googleplay',
  ...
  },
  {
    ...
    aiComment: {
      ...
      huaweiImpact: 'DMA的成功实施为华为进入欧洲市场提供了更公平的竞争环境。虽然华为目前未被指定为守门人，但随着业务扩展，可能面临类似监管要求。华为应提前研究DMA合规框架，为未来可能的监管做好准备，同时利用DMA创造的开放环境拓展欧洲市场。',
    },
    publishDate: '2026-04-21',
    score: 8,
    category: 'dma',
  ...
  },
  {
    ...
    aiComment: {
      ...
      huaweiImpact: '苹果的设计标准化对华为既是挑战也是机遇。华为可以借鉴苹果的统一设计理念，推动鸿蒙应用的设计规范化。同时，开发者适配iOS 26的成本可能促使部分开发者重新评估多平台开发策略，华为可借此机会吸引开发者关注鸿蒙生态。',
    },
    publishDate: '2026-04-21',
    score: 7,
    category: 'appstore',
