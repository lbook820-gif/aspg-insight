...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    aiComment: {
      ...
      huaweiImpact: '对于华为等正在全球布局算力网络与 AI 云服务的企业而言，这也是重大利好与挑战并存的时刻。一方面，RK 遏制美国科技巨头（如微软、谷歌、亚马逊）的自我优待，为华为等第三方云基础设施和 AI 解决方案提供商在土耳其乃至中东市场的公平竞争留出了空间；另一方面，华为在部署本地化 AI 方案时，需更加注意数据采集与处理的合规透明度，以及其软硬件解耦的开放性承诺。',
    },
    publishDate: '2026-04-26',
    score: 8,
    category: 'dma',
