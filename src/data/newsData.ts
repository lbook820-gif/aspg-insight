...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    aiComment: {
      ...
      huaweiImpact: '华为AppGallery和Petal Maps目前尚未大规模商业化。苹果的广告扩张模式为华为提供了双重参考：AppGallery可考虑优化广告平台吸引开发者投放，同时也可主打"更少广告干扰"的差异化策略；Petal Maps可借鉴苹果地图广告模式，引入本地广告系统为商户提供精准营销服务。华为应在商业化与用户体验间找到平衡，借鉴苹果的隐私保护做法建立用户信任。',
    },
    publishDate: '2026-04-21',
    score: 8,
    category: 'appstore',
