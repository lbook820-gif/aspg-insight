...
export const newsData: NewsItem[] = [
  ...
  {
    id: '41',
    title: '华为发布鸿蒙应用开发者激励计划2026，单开发者最高可获百万',
    source: '新浪',
    sourceUrl: 'https://k.sina.com.cn/article_7879848900_1d5acf3c401902x7ki.html',
    summary: '2026年4月16日，华为HarmonyOS官方宣布鸿蒙应用开发者激励计划2026正式发布。面向所有鸿蒙开发者，在2026年3月12日至9月30日期间完成鸿蒙应用开发并上架至华为应用市场的开发者可获得激励。热门应用最高1万元/个，新应用3000元/个，单开发者最高可获百万激励。',
    aiComment: {
      overallImpact: '华为以真金白银投入加速鸿蒙应用生态建设，这是继2024年首批激励计划后的再次加码。此举将显著降低开发者迁移成本，刺激第三方应用快速适配鸿蒙原生生态，对打破Android/iOS双寡头格局具有战略意义。全球应用分发市场或将迎来第三极的真正崛起。',
      huaweiImpact: '这是华为生态建设的里程碑式投入。高额现金激励将直接吸引更多头部和长尾开发者加入鸿蒙阵营，快速填补应用缺口。对华为而言，这不仅是一笔营销支出，更是构建自有生态护城河的必要投资，将加速HarmonyOS NEXT从"能用"到"好用"的质变。',
    },
    publishDate: '2026-04-16',
    score: 9,
    category: 'huawei',
    tags: ['华为', 'AppGallery', '开发者', '激励', '鸿蒙', 'HarmonyOS'],
  },
  {
    id: '42',
    title: '鸿蒙终端设备突破5000万台，日均新增超15万',
    source: '中国网',
    sourceUrl: 'http://bjtime.china.com.cn/2026-04/17/content_43401731.html',
    summary: '4月15日，鸿蒙生态视听行业峰会在第十三届中国网络视听大会期间举办。截至2026年3月，鸿蒙终端设备已突破5000万台，日均新增设备超15万台，注册开发者数量超千万。哔哩哔哩、腾讯视频、优酷、爱奇艺、芒果等上千家头部视听应用全部完成适配，接入100多个鸿蒙创新能力。',
    aiComment: {
      overallImpact: '5000万台终端设备和千万级开发者标志着鸿蒙生态已跨过规模临界点。视听行业上千家头部应用全部适配，说明鸿蒙不再只是"备胎系统"，而是万物互联时代不可忽视的内容分发主渠道。全场景互联和AI能力的落地，正在重新定义移动视听体验标准。',
      huaweiImpact: '这是华为生态从量变到质变的信号。5000万台设备和千万开发者意味着华为已建立起足以与Android/iOS抗衡的用户基础和内容供给。日均15万台的新增速度表明市场接受度在快速提升。对华为而言，这证明了"去安卓化"战略的可行性，也为后续全球扩张奠定了数据基础。',
    },
    publishDate: '2026-04-15',
    score: 8,
    category: 'huawei',
    tags: ['华为', '鸿蒙', 'HarmonyOS', '视听', '设备增长', '生态'],
  },
  {
    id: '43',
    title: '华为应用商店2026算法新增鸿蒙生态适配权重，ASO策略全面升级',
    source: 'CSDN',
    sourceUrl: 'https://blog.csdn.net/berkoo/article/details/160288838',
    summary: '华为应用市场（AppGallery）2026年ASO算法迎来重大调整，新增"鸿蒙生态适配"权重（占比10%）。新算法六大板块为：应用名称/标题（30%）、后台关键词（20%）、应用描述（15%）、评分评论（15%）、下载活跃留存（10%）、鸿蒙生态适配（10%）。鸿蒙原生应用和多端适配将获得生态流量倾斜。',
    aiComment: {
      overallImpact: '华为将鸿蒙适配纳入ASO核心权重，是用算法杠杆推动生态迁移的精明策略。通过流量倾斜激励开发者主动适配鸿蒙原生，而非仅靠政策要求。这标志着华为应用市场已从"兼容安卓"转向"优先鸿蒙"，分发逻辑正在发生根本性转变。',
      huaweiImpact: '对华为而言，这是一石三鸟的运营策略：既加速了鸿蒙原生应用的供给，又提升了应用市场的差异化竞争力，还通过算法透明度增强了与开发者的信任关系。10%的权重足以改变开发者的优先级排序，将倒逼更多应用完成鸿蒙原生适配，进一步巩固华为自有生态闭环。',
    },
    publishDate: '2026-04-18',
    score: 7,
    category: 'huawei',
    tags: ['华为', 'AppGallery', 'ASO', '算法', '鸿蒙', '流量'],
  },
];
